...
Main.prototype = $extend(snow_App.prototype,{
	...
	,lowerQualityRequired: function(magnitude) {
		...
		haxe_Log.trace("Average FPS: " + this.performanceMonitor.fpsSample.average + ", lowering quality to: " + Std.string(newQuality),{ fileName : "Main.hx", lineNumber : 394, className : "Main", methodName : "lowerQualityRequired"});
		this.set_simulationQuality(newQuality);
		this.updateSimulationTextures();
		this.updatePointSize();
		haxe_Log.trace("lower quality required",{ fileName : "Main.hx", lineNumber : 398, className : "Main", methodName : "lowerQualityRequired"});
	}
	,higherQualityRequired: function(magnitude) {
		...
		var newQuality = Type.createEnumIndex(SimulationQuality,qualityIndex);
		haxe_Log.trace("Raising quality to: " + Std.string(newQuality),{ fileName : "Main.hx", lineNumber : 416, className : "Main", methodName : "higherQualityRequired"});
		this.set_simulationQuality(newQuality);
		this.updateSimulationTextures();
		this.updatePointSize();
	}
