...
Main.prototype = $extend(snow_App.prototype,{
	...
	,update: function(dt) {
		...
		window.document.getElementById("fps").innerHTML = this.performanceMonitor.fpsSample.average + "";
		dt = 0.016;
	...
	,lowerQualityRequired: function(magnitude) {
		...
		haxe_Log.trace("Average FPS: " + this.performanceMonitor.fpsSample.average + ", lowering quality to: " + Std.string(newQuality),{ fileName : "Main.hx", lineNumber : 408, className : "Main", methodName : "lowerQualityRequired"});
	...
	,higherQualityRequired: function(magnitude) {
		...
		var newQuality = Type.createEnumIndex(SimulationQuality,qualityIndex);
		haxe_Log.trace("Raising quality to: " + Std.string(newQuality),{ fileName : "Main.hx", lineNumber : 430, className : "Main", methodName : "higherQualityRequired"});
		this.set_simulationQuality(newQuality);
		this.updateSimulationTextures();
		this.updatePointSize();
	}
