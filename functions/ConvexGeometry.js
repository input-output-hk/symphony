...
(0, _assign2.default)(QuickHull.prototype, {
	...
	computeExtremes: function computeExtremes() {
		...
		this.tolerance = 3 * _epsilon2.default * (Math.max(Math.abs(min.x), Math.abs(max.x)) + Math.max(Math.abs(min.y), Math.abs(max.y)) + Math.max(Math.abs(min.z), Math.abs(max.z)));
...
(0, _assign2.default)(Face.prototype, {
...
(0, _assign2.default)(HalfEdge.prototype, {
...
(0, _assign2.default)(VertexList.prototype, {
...
ConvexGeometry.prototype = (0, _create2.default)(THREE.Geometry.prototype);
...
ConvexBufferGeometry.prototype = (0, _create2.default)(THREE.BufferGeometry.prototype);
...
module.exports = { ConvexGeometry: ConvexGeometry, ConvexBufferGeometry: ConvexBufferGeometry };