...
function io_intro_explorer () {
  ...
  <div class="controls top none">\
    <div class="container">\
      <div class="inner">\
        <div class="inline-block pane sound sound_control">\
          <a href="javascript:io_class_toggle(\'.sound_control\',\'off\')" id="mute"><em class="fa fa-volume-off"></em></a><a href="javascript:io_class_toggle(\'.sound_control\',\'off\')" id="unmute"><em class="fa fa-volume-up"></em></a>\
        </div>\
        ...
        <div class="inline-block pane search nomobile">\
          <div class="search_control"><a href="javascript:io_class_toggle(\'#search_box\',\'none\')"><em class="fa fa-search"></em></a></div>\
        </div>\
      </div>\
    </div>\
  </div>\
  ...
  <div class="block pane left bottom off">\
    <a href="javascript:io_class_toggle(\'.pane.bottom\',\'off\')" class="opener"><span class="off"><img src="/static/assets/images/close.svg" alt="&times;" /></span><em class="fa fa-info on"></em></a>\
  ...
  <div id="search_box" class="none">\
    <a href="javascript:io_class_toggle(\'#search_box\',\'none\')" class="opener"><span class="off"><img src="/static/assets/images/close.svg" alt="&times;" /></span></a>\
    <div class="container">\
  ...
  // app.destroy()
    ...
    */
    ...
    app.on('dayChanged', ({ date, input, output, fee }) => {
      ...
      hudx = '\
      <a href="javascript:io_class_toggle(\'.pane.left.top\',\'off\')" class="opener"><span class="off"><img src="/static/assets/images/close.svg" alt="&times;" /></span><em class="fa fa-calendar on"></em></a>\
      <span class="link"></span>\
      <div class="inner">\
      \
      <h4 class="tit"><span>Bitcoin Blockchain</span> <br class="" /><b class="date">' + date_nice(date) + '</b>  &nbsp; <span class="pull-right none">\
        <a href="#" title="Previous day" class="day_prev" rel="' + date_prev.getFullYear() + '/' + date_prev.getMonth() + '/' + date_prev.getDate() + '"><em class="fa fa-angle-left"></em></a> &nbsp; \
        <a href="#" title="Next day" class="day_prev" rel="' + date_next.getFullYear() + '/' + date_next.getMonth() + '/' + date_next.getDate() + '"><em class="fa fa-angle-right"></em></a>\
      </span></h4>\
      <div class="ul">\
      ...
      $('.pane.left.bottom').removeClass('off')
      //$('#details').removeClass('empty').html(hudx)controls
    ...
    */
    ...
    hudx = '\
        <a href="javascript:io_class_toggle(\'.pane.middle\',\'off\')" class="opener"><span class="off"><img src="/static/assets/images/close.svg" alt="&times;" /></span><em class="fa fa-bitcoin on"></em></a>\
        <span class="link"></span>\
        <div class="inner">\
        <h4 class="tit"><b>Block ' + hash.substr(-16) + '</b></h4>\
          <div class="ul">\
          <div class="li"><small>Block time</small> <b>' + datetime_nice(time) + '</b></div>\
          ...
          <div class="controls text-center"><a href="#" title="Previous block" class="block_prev"><em class="fa fa-angle-left"></em></a> <a href="#" title="Next block" class="block_next"><em class="fa fa-angle-right"></em></a></div>\
        </div>\
        '
    //$('#details').html(hudx)
